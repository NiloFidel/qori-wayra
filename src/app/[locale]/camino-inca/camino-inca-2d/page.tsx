    ...
    itinerary: [
      {
        ...
        text: (
          <>
            <p>Salida temprano desde Cusco hacia Ollantaytambo, donde tomaremos el tren hacia el Km 104. Desde allí, comenzamos nuestra caminata por senderos incas rodeados de vegetación y montañas. Visitamos el sitio arqueológico de Wiñay Wayna y seguimos hasta la Puerta del Sol, con la primera vista panorámica de Machu Picchu.</p>
            <p>Tras una pausa para fotos, descendemos a Aguas Calientes, donde nos registramos en el hotel y disfrutamos de una cena bien merecida.</p>
          </>
        ),
      ...
      },
      {
        ...
        text: (
          <>
            <p>Nos levantamos temprano para tomar el bus a Machu Picchu y ver el amanecer en la ciudadela. Realizamos un recorrido guiado por los puntos más importantes y aprendemos sobre su historia.</p>
            <p>Después del tour, tenemos tiempo libre antes de tomar el tren y bus de regreso a Cusco.</p>
          </>
        ),
    ...
    itinerary: [
      {
        ...
        text: (
          <>
            ...
            <p>Continuing our hike, we arrive at the Sun Gate (Inti Punku) with a breathtaking first view of Machu Picchu. After enjoying the scenery, we descend to Aguas Calientes, where we check into our hotel and enjoy a well-deserved dinner.</p>
          </>
        ),
      ...
      },
      {
        ...
        text: (
          <>
            <p>We wake up early to take the bus to Machu Picchu and witness the sunrise over the ancient citadel. Our guided tour explores the most significant areas, providing insights into its rich history and breathtaking architecture.</p>
            <p>After the tour, we have free time to explore before boarding the train and bus back to Cusco.</p>
          </>
        ),
